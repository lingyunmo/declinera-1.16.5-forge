...
package net.declinera.world.biome;
...
import net.declinera.block.ListenTreeLogBlock;
import net.declinera.block.ListenTreeLeavesBlock;
import net.declinera.block.ListenGrassBlock;
import net.declinera.DeclineraModElements;

import com.google.common.collect.ImmutableList;

@DeclineraModElements.ModElement.Tag
public class ListenBiome extends DeclineraModElements.ModElement {
	public static Biome biome;

	public ListenBiome(DeclineraModElements instance) {
		super(instance, 32);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-16724788).setWaterColor(-16724788).setWaterFogColor(-13369345)
						.withSkyColor(-16724788).withFoliageColor(-16724788).withGrassColor(-16737895).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(ListenGrassBlock.block.getDefaultState(),
								Blocks.DIRT.getDefaultState(), Blocks.DIRT.getDefaultState())));
				biomeGenerationSettings.withStructure(StructureFeatures.RUINED_PORTAL_DESERT);
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration(
								(new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(ListenTreeLogBlock.block.getDefaultState()),
										new SimpleBlockStateProvider(ListenTreeLeavesBlock.block.getDefaultState()),
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.SEAGRASS
						.withConfiguration(new ProbabilityConfig(0.3F)).func_242731_b(4).withPlacement(Features.Placements.SEAGRASS_DISK_PLACEMENT));
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
						Feature.DISK
								.withConfiguration(new SphereReplaceConfig(Blocks.SAND.getDefaultState(), FeatureSpread.func_242253_a(2, 4), 2,
										ImmutableList.of(ListenGrassBlock.block.getDefaultState(), Blocks.DIRT.getDefaultState())))
				...
				event.getRegistry().register(biome.setRegistryName("declinera:listen"));
			}
		}
	}
