...
import net.declinera.potion.DivingEffectPotionEffect;
...
public class DivingBerryBlock extends DeclineraModElements.ModElement {
	@ObjectHolder("declinera:diving_berry")
	public static final Block block = null;

	public DivingBerryBlock(DeclineraModElements instance) {
		super(instance, 6);
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 100, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.SWEET_BERRY_BUSH)
					.hardnessAndResistance(0f, 0f).setLightLevel(s -> 0));
			setRegistryName("diving_berry");
		}

		@Override
		public Effect getStewEffect() {
			return DivingEffectPotionEffect.potion;
		}
